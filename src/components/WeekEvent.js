    ...
    render() {
        ...
        return (
            <TableRow key={this.props.eventData.key}>
                ...
                {!this.state.isEditing && <TableCell style={styles.cell}>{this.props.eventData.name}</TableCell>}
                {!this.state.isEditing && <TableCell align="center" style={styles.cell}>{getTypeIcon(this.props.eventData.type)}</TableCell>}
                {(!this.state.isEditing && this.props.eventData.ol === 1) && <TableCell align="center" style={styles.smallCell}><Checkbox checked={true} disabled style={styles.checkbox}/></TableCell>}
                {(!this.state.isEditing && this.props.eventData.ol === 0) && <TableCell align="center" style={styles.smallCell}>&nbsp;</TableCell>}
                {(!this.state.isEditing && this.props.eventData.night === 1) && <TableCell align="center" style={styles.smallCell}><Checkbox checked={true} disabled style={styles.checkbox}/></TableCell>}
                {(!this.state.isEditing && this.props.eventData.night === 0) && <TableCell align="center" style={styles.smallCell}>&nbsp;</TableCell>}
                {(!this.state.isEditing && this.props.eventData.quality === 1) && <TableCell align="center" style={styles.smallCell}><Checkbox checked={true} disabled style={styles.checkbox}/></TableCell>}
                {(!this.state.isEditing && this.props.eventData.quality === 0) && <TableCell align="center" style={styles.smallCell}>&nbsp;</TableCell>}
                {(!this.state.isEditing && this.props.eventData.lsd === 1) && <TableCell align="center" style={styles.smallCell}><Checkbox checked={true} disabled style={styles.checkbox}/></TableCell>}
                {(!this.state.isEditing && this.props.eventData.lsd === 0) && <TableCell align="center" style={styles.smallCell}>&nbsp;</TableCell>}
                {(!this.state.isEditing && this.props.eventData.strength === 1) && <TableCell align="center" style={styles.smallCell}><Checkbox checked={true} disabled style={styles.checkbox}/></TableCell>}
                {(!this.state.isEditing && this.props.eventData.strength === 0) && <TableCell align="center" style={styles.smallCell}>&nbsp;</TableCell>}
                {(!this.state.isEditing && this.props.eventData.alternative === 1) && <TableCell align="center" style={styles.smallCell}><Checkbox checked={true} disabled style={styles.checkbox}/></TableCell>}
                {(!this.state.isEditing && this.props.eventData.alternative === 0) && <TableCell align="center" style={styles.smallCell}>&nbsp;</TableCell>}
                {(!this.state.isEditing && this.props.eventData.forest === 1) && <TableCell align="center" style={styles.smallCell}><Checkbox checked={true} disabled style={styles.checkbox}/></TableCell>}
                {(!this.state.isEditing && this.props.eventData.forest === 0) && <TableCell align="center" style={styles.smallCell}>&nbsp;</TableCell>}
                {(!this.state.isEditing && this.props.eventData.path === 1) && <TableCell align="center" style={styles.smallCell}><Checkbox checked={true} disabled style={styles.checkbox}/></TableCell>}
                {(!this.state.isEditing && this.props.eventData.path === 0) && <TableCell align="center" style={styles.smallCell}>&nbsp;</TableCell>}
                {!this.state.isEditing && <TableCell align="right" style={styles.cell}>{getDistance(this.props.eventData.distance)}</TableCell>}
                {!this.state.isEditing && <TableCell align="right" style={styles.cell}>{getTime(this.props.eventData.movingTime)}</TableCell>}
                
                {this.state.isEditing && <TableCell style={styles.cell}><TextField variant="outlined" multiline={true} fullWidth={true} rows={3} value={this.state.name} onChange={(e) => this.setState({ name: e.target.value })} name="nameField"/></TableCell>}
                {this.state.isEditing && <TableCell style={styles.cell}><Select defaultValue={this.props.eventData.type} onChange={(e) => this.setState({ type: e.target.value })}><MenuItem value="ol"><img src={process.env.PUBLIC_URL + '/olskarm.png'} alt="OL" height={16} width={16}/><span>OL</span></MenuItem><MenuItem value="night"><NightsStayIcon/><span>Natt-OL</span></MenuItem><MenuItem value="Run"><DirectionsRunOutlinedIcon/><span>Löpning</span></MenuItem><MenuItem value="Ride"><DirectionsBikeOutlinedIcon/><span>Cykel</span></MenuItem><MenuItem value="VirtualRide"><DirectionsBikeOutlinedIcon/><span>Cykel inne</span></MenuItem><MenuItem value="WeightTraining"><FitnessCenterOutlinedIcon/><span>Styrketräning</span></MenuItem><MenuItem value="Swim"><PoolIcon/><span>Simning</span></MenuItem><MenuItem value="Workout"><AccessibilityNewIcon/><span>Annat</span></MenuItem><MenuItem value="NordicSki"><img src={process.env.PUBLIC_URL + '/ski.png'} alt="Ski" height={16} width={16}/><span>Skidor</span></MenuItem><MenuItem value="RollerSki"><img src={process.env.PUBLIC_URL + '/ski.png'} alt="Rullskidor" height={16} width={16}/><span>Rullskidor</span></MenuItem><MenuItem value="Kayaking"><img src={process.env.PUBLIC_URL + '/kayak.png'} alt="Kayak" height={16} width={16}/><span>Kajak</span></MenuItem><MenuItem value="Walk"><DirectionsWalkIcon/><span>Gång</span></MenuItem></Select></TableCell>}
                {this.state.isEditing && <TableCell align="center" style={styles.smallCell}><Checkbox checked={this.state.ol} onChange={(e) => this.setState({ ol: e.target.checked })} style={styles.checkbox}/></TableCell>}
                {this.state.isEditing && <TableCell align="center" style={styles.smallCell}><Checkbox checked={this.state.night} onChange={(e) => this.setState({ night: e.target.checked })} style={styles.checkbox}/></TableCell>}
                {this.state.isEditing && <TableCell align="center" style={styles.smallCell}><Checkbox checked={this.state.quality} onChange={(e) => this.setState({ quality: e.target.checked })} style={styles.checkbox}/></TableCell>}
                {this.state.isEditing && <TableCell align="center" style={styles.smallCell}><Checkbox checked={this.state.lsd} onChange={(e) => this.setState({ lsd: e.target.checked })} style={styles.checkbox}/></TableCell>}
                {this.state.isEditing && <TableCell align="center" style={styles.smallCell}><Checkbox checked={this.state.strength} onChange={(e) => this.setState({ strength: e.target.checked })} style={styles.checkbox}/></TableCell>}
                {this.state.isEditing && <TableCell align="center" style={styles.smallCell}><Checkbox checked={this.state.alternative} onChange={(e) => this.setState({ alternative: e.target.checked })} style={styles.checkbox}/></TableCell>}
                {this.state.isEditing && <TableCell align="center" style={styles.smallCell}><Checkbox checked={this.state.forest} onChange={(e) => this.setState({ forest: e.target.checked })} style={styles.checkbox}/></TableCell>}
                {this.state.isEditing && <TableCell align="center" style={styles.smallCell}><Checkbox checked={this.state.path} onChange={(e) => this.setState({ path: e.target.checked })} style={styles.checkbox}/></TableCell>}

                {this.state.isEditing && <TableCell style={styles.dataCell}><TextField variant="outlined" fullWidth={true} value={this.state.distance} onChange={this.correctDistance} error={this.validateDistance()} helperText={this.validateDistance() ? 'Fel' : ' '}/></TableCell>}
                {this.state.isEditing && <TableCell style={styles.dataCell}><TextField variant="outlined" fullWidth={true} value={this.state.movingTime} onChange={this.correctMovingTime} error={this.validateMovingTime()} helperText={this.validateMovingTime() ? 'Fel' : ' '}/></TableCell>}
            </TableRow>
        );
    }
}
